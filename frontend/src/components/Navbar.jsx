...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Quick Booking', path: '/booking' },
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              ...
              className="flex items-center space-x-1 text-slate-700 hover:text-brand-500 font-semibold text-sm transition-colors"
            >
              <Phone className="h-4 w-4 text-brand-500 animate-bounce" />
              <span>+91-9150549150</span>
            </a>
            <Link
              to="/booking"
              className="bg-brand-500 hover:bg-brand-600 text-white font-bold px-5 py-2.5 rounded-2xl shadow-lg shadow-brand-500/20 hover:shadow-brand-600/30 hover:-translate-y-0.5 transition-all duration-200 text-sm"
            >
              Book Rental
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden animate-fade-in absolute top-full left-0 right-0 bg-white shadow-xl border-t border-slate-100 px-4 py-6 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col space-y-3 px-4">
            <a
              href="tel:+919150549150"
              className="flex items-center justify-center space-x-2 text-slate-700 font-bold py-2.5 hover:text-brand-500 transition-colors border border-slate-200 rounded-xl"
            >
              <Phone className="h-4 w-4 text-brand-500 animate-bounce" />
              <span>Call +91-9150549150</span>
            </a>
            <Link
              to="/booking"
              className="bg-brand-500 hover:bg-brand-600 text-white text-center font-bold py-3 rounded-xl shadow-lg shadow-brand-500/20"
            >
              Book Rental Now
            </Link>
          </div>
