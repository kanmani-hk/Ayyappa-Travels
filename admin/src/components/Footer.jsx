    ...
    <footer className="bg-slate-900 text-slate-400 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-slate-800 text-center md:flex md:justify-between md:items-center text-xs text-slate-500">
          <p>© {currentYear} Ayyappa Travels Srivilliputtur. All rights reserved. | <Link to="/login" className="hover:text-brand-500 transition-colors ml-1">Admin Login</Link></p>
